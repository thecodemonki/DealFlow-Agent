...
async def main():
    ...
    logger.info("  • Orchestrator     (LangGraph + Claude Sonnet / AI/ML API)")
    logger.info("  • Document Parser  (Pydantic AI + Mistral-7B / Featherless)")
    logger.info("  • Financial Analyst(LangGraph + Qwen2.5-72B / Featherless)")
    logger.info("  • Legal Risk       (CrewAI + Llama-3.1-70B / Featherless)")
    logger.info("  • Web Research     (LangGraph + Claude Haiku / AI/ML API)")
    logger.info("  • Synthesis        (LangGraph + Claude Sonnet / AI/ML API)")
