...
def format_final_signal(memo: dict) -> str:
    ...
    summary = {
        ...
        "legal_score": memo.get("legal_score"),
        "financial_score": memo.get("financial_score"),
        "market_score": memo.get("market_score"),
        "regulatory_score": memo.get("regulatory_score"),
        "team_score": memo.get("team_score"),
